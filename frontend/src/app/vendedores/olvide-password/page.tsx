...
export default function OlvidePasswordVendedorPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/vendedores/auth/forgot-password', {
        method: 'POST',
    ...
    <main className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#f7f4ef' }}>
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-zinc-200/80 p-8">
        ...
        <div className="mt-6 pt-6 border-t border-zinc-100 text-center">
          <Link href="/vendedores" className="text-sm text-zinc-500 hover:text-primary-600 hover:underline">
