...
function ProductCard({
  ...
  function handleAdd() {
    onAdd(
      { producto_id: p.id, nombre: p.nombre, imagen_url: p.imagen_url, precio_comercio: p.precio_comercio },
      cantidad,
    )
    setAdded(true)
    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden flex flex-col">
      ...
      <div className="p-3 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-center gap-1">
          <span className="text-xs text-gray-400 bg-gray-100 rounded px-1.5 py-0.5">Comercio</span>
        </div>
