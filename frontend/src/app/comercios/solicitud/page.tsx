    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-10 max-w-md w-full text-center">
          ...
          <Link href="/comercios" className="mt-6 inline-block text-sm text-gray-500 hover:underline">
            Volver al inicio
          </Link>
        </div>
      </main>
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="mb-6">
          <Link href="/comercios" className="text-sm text-gray-500 hover:underline">
            ← Volver
          </Link>
          <h1 className="text-2xl font-bold text-gray-800 mt-3">Solicitud de acceso comercio</h1>
