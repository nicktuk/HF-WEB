...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("frecuencia_scraping", sa.String(20), nullable=False, server_default="'diaria'"),
        sa.Column("flag_restriccion", sa.String(100), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("tipo", sa.String(20), nullable=False, server_default="'online'"),
        sa.Column("base_url", sa.String(500), nullable=False),
        sa.Column("search_url_template", sa.String(1000), nullable=False),
        sa.Column("scraper_implementacion", sa.String(100), nullable=False, server_default="''"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("nombre", sa.String(200), nullable=False, unique=True),
        sa.Column("tipo", sa.String(20), nullable=False, server_default="'tienda'"),
    ...
    op.create_table(
        ...
        sa.Column("modo_compra", sa.String(20), nullable=False, server_default="'online'"),
    ...
    op.create_table(
        ...
        sa.Column("productos", JSON, nullable=False, server_default="'[]'"),
